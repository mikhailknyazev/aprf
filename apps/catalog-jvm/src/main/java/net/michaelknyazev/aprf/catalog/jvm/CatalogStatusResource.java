...
/**
 * Exposes the catalog product route and the bounded fault routes used by the
 * APRF drills.
 */
...
public class CatalogStatusResource {
    ...
    private final CatalogJvmService service;

    public CatalogStatusResource(CatalogJvmService service) {
    ...
    public Response flaky() {
        ...
        return Response.ok(service.current(FaultMode.FLAKY)).build();
    }
}
